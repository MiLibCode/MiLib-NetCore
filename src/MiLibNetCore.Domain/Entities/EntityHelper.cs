...
namespace MiLibNetCore.Domain.Entities
{
    /// <summary>
    ...
    public static class EntityHelper
    {
        ...
        public static Type FindPrimaryKeyType([NotNull] Type entityType)
        {
            ...
            {
                throw new MiException($"Given {nameof(entityType)} is not an entity. It should implement {typeof(IEntity).AssemblyQualifiedName}!");
            }
